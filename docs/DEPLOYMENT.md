...
FAIRPLAY_AUTO_SANCTIONS_ENABLED=false
FAIRPLAY_AUTO_SANCTIONS_SHADOW=true
...
# Optionnel — refresh JWT en cookie HttpOnly (web uniquement)
JWT_REFRESH_HTTPONLY=true
NEXT_PUBLIC_JWT_REFRESH_HTTPONLY=true
