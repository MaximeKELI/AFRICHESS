...
export const BASICS_STAGES: BasicsStage[] = [
  ...
  },
  {
    ...
    fen: "7k/8/8/8/4B3/8/8/4K3 w - - 0 1",
    goal: { type: "dest", squares: ["a8", "c2", "d3", "f3", "g2", "b1", "h1", "c6"] },
  },
  {
    id: "queen",
    titleKey: "learn.basics.queen.title",
    hintKey: "learn.basics.queen.hint",
    fen: "7k/8/8/8/4Q3/8/8/4K3 w - - 0 1",
  ...
  },
  {
    ...
    fen: "7k/8/8/8/4N3/8/8/4K3 w - - 0 1",
  ...
  },
  {
    ...
    fen: "7k/8/8/3r4/4N3/8/8/4K3 w - - 0 1",
