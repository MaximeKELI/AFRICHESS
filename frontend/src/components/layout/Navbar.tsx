    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <>
          <button
            type="button"
            className="fixed inset-0 top-14 md:top-16 z-[45] bg-black/40"
            aria-label={t("nav.menu.close")}
            onClick={close}
          />
          <div className="fixed left-0 right-0 top-14 md:top-16 z-[55] border-b border-white/10 bg-[var(--card)]/98 backdrop-blur-lg shadow-2xl">
