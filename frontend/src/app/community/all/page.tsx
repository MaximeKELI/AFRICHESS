...
export default function CommunityAllPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
          <Link href="/forum" className="text-sm text-africhess-gold hover:underline mb-4 inline-block">
        ← {t("forum.back")}
      </Link>
      ...
      <ul className="space-y-2">
        {posts.map((p) => (
          <li key={p.id}>
            <Link href={`/forum/${p.id}`} className="glass-card p-4 block hover:ring-2 ring-africhess-gold/20">
