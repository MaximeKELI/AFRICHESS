...
Call log:
  - navigating to "http://127.0.0.1:3000/profile", waiting until "domcontentloaded"
...
```ts
  ...
  13 |     const loginLink = page.getByRole("navigation").getByRole("link", { name: /connexion|login/i });
