# Chess piece sets (from Lichess / lila)

SVG assets copied from [lichess-org/lila](https://github.com/lichess-org/lila) `public/piece/`.

Only sets with redistribution-friendly licenses are included (no CC BY-NC).
