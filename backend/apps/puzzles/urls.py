...
urlpatterns = [
    ...
    path("streak-run/start/", views.PuzzleStreakRunStartView.as_view(), name="puzzle-streak-run-start"),
    path("streak-run/<int:session_id>/submit/", views.PuzzleStreakRunSubmitView.as_view(), name="puzzle-streak-run-submit"),
    ...
    path("dashboard/", views.PuzzleDashboardView.as_view(), name="puzzle-dashboard"),
