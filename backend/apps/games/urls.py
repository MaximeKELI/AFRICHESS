...
urlpatterns = [
    ...
    path("lobby/", views.LobbySeekListCreateView.as_view(), name="lobby-seeks"),
    path("lobby/<int:pk>/accept/", views.LobbySeekAcceptView.as_view(), name="lobby-seek-accept"),
    path("lobby/<int:pk>/", views.LobbySeekCancelView.as_view(), name="lobby-seek-cancel"),
