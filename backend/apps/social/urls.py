...
urlpatterns = [
    ...
    path("friends/unblock/<str:username>/", views.UnblockUserView.as_view(), name="friend-unblock"),
    ...
    path("clubs/<slug:slug>/leave/", views.LeaveClubView.as_view(), name="club-leave"),
    path("clubs/<slug:slug>/kick/", views.KickClubMemberView.as_view(), name="club-kick"),
