...
# Analyse post-partie automatique (moteur en arrière-plan)
...
# Plafond temps/coup pour l'analyse manuelle (évite les attentes longues)
SYNC_ANALYSIS_MOVETIME_MS = config("SYNC_ANALYSIS_MOVETIME_MS", default=120, cast=int)
